...
def register(request):
    ...
    return render(request, 'onepiece/register.html', context)
...
def my_login(request):
    ...
    return render(request, 'onepiece/my-login.html', context)
...
def dashboard(request):
    ...
    return render(request, 'onepiece/dashboard.html', context)
...
def create_thought(request):
    ...
    return render(request, 'onepiece/create-thought.html', context)
...
def my_thoughts(request):
    ...
    return render(request, 'onepiece/my-thoughts.html', context)
...
def update_thought(request, pk):
    ...
    return render(request, 'onepiece/update-thought.html', context)
...
def delete_thought(request, pk):
    ...
    return render(request, 'onepiece/delete-thought.html')
...
def profile_management(request):
    ...
    return render(request, 'onepiece/profile-management.html', context)
...
def delete_account(request):
    ...
    if request.method == 'POST':
        ...
        deleteUser.delete()
        return redirect("")
    return render(request, 'onepiece/delete-account.html')
